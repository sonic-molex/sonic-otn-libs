...
public:
    virtual_otn_wss_device(sai_object_id_t id, sai_object_type_extensions_t type)
        : virtual_otn_device(id, type),
          ...
          attr_attenuation_control_mode(SAI_OTN_WSS_ATTENUATION_CONTROL_MODE_SET_ATTENUATION),
          attr_attenuation_control_range(SAI_OTN_WSS_ATTENUATION_CONTROL_RANGE_FULL),
